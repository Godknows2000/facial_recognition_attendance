...
from facial_attendance.settings import BASE_DIR
...
from base.models import Present, Time
from base.models import Attendance, AttendanceLog
    ...
    while True:
        ...
        for face in faces:
            ...
            if face_aligned is None:
                print("Face alignment returned None.")
                continue
